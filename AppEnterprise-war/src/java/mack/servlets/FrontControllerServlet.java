...
public class FrontControllerServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			control.init(request, usuarioBean);
			control.execute();
			List<Cookie> cookies = control.getCookies();
			if (cookies != null) {
			...
			if(control.getMensagem() != null) {
				request.setAttribute("msgErro", control.getMensagem());
			}
	...
	// the + signon the left to edit the code.">
